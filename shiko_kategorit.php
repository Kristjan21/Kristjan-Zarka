<table width="795px" align="center" class="table">
    <tr>
        <td colspan="6" align="center"><h2>Shiko te gjitha kategorite <h2></td>
    </tr>
    ...
    <tr align="center" style="border-top:1px solid black;">
        <td><?php echo $i?></td>
        <td><?php echo $titull_kategori?></td>
        <td><a href="fshi_kategori.php?fshi_kategori=<?php echo $id_kategori; ?>">Fshi</a></td>
    </tr>
